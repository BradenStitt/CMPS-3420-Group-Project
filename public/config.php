...
function get_pdo_connection() {
    ...
    if (!isset($conn)) {
        try {
            ...
            $conn = new PDO(
                "mysql:host=localhost;dbname=databaes",      // change dbname
                "databaes",                                  // change username
                "rim)6Qvez",                                 // change password
                $options);
...
require_once("lab8/FormBuilder.php");
...
require_once("lab8/tablemaker.php");
?>
